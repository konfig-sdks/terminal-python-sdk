...
from terminal_python_sdk.paths.vehicles_vehicle_id_stats_historical import get
from terminal_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestVehiclesVehicleIdStatsHistorical(ApiTestMixin, unittest.TestCase):
    """
    VehiclesVehicleIdStatsHistorical unit test stubs
