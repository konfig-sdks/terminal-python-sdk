...
from terminal_python_sdk.paths.vehicles_locations import get
from terminal_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestVehiclesLocations(ApiTestMixin, unittest.TestCase):
    """
    VehiclesLocations unit test stubs
