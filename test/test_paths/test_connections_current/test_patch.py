...
from terminal_python_sdk.paths.connections_current import patch
from terminal_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestConnectionsCurrent(ApiTestMixin, unittest.TestCase):
    """
    ConnectionsCurrent unit test stubs
