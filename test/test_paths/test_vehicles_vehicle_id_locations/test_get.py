...
from terminal_python_sdk.paths.vehicles_vehicle_id_locations import get
from terminal_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestVehiclesVehicleIdLocations(ApiTestMixin, unittest.TestCase):
    """
    VehiclesVehicleIdLocations unit test stubs
