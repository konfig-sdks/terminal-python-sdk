...
from terminal_python_sdk.paths.trailers_locations import get
from terminal_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestTrailersLocations(ApiTestMixin, unittest.TestCase):
    """
    TrailersLocations unit test stubs
