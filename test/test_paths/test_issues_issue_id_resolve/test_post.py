...
from terminal_python_sdk.paths.issues_issue_id_resolve import post
from terminal_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestIssuesIssueIdResolve(ApiTestMixin, unittest.TestCase):
    """
    IssuesIssueIdResolve unit test stubs
        Resolve Issue
    """
