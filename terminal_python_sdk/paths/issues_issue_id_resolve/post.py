...
class BaseApi(api_client.Api):
    ...
    def _mark_resolved_mapped_args(
        self,
        issue_id: str,
...
class MarkResolvedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amark_resolved(
        self,
        issue_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._mark_resolved_mapped_args(
            issue_id=issue_id,
        )
...
class MarkResolved(BaseApi):
    ...
    async def amark_resolved(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amark_resolved(
            issue_id=issue_id,
            **kwargs,
        )
    ...
    def mark_resolved(
        ...
        raw_response = self.raw.mark_resolved(
            issue_id=issue_id,
        )
