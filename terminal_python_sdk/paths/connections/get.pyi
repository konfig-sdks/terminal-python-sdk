...
DotNumberSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'dotNumber': typing.Union[DotNumberSchema, str, ],
...
request_query_dot_number = api_client.QueryParameter(
    name="dotNumber",
    style=api_client.ParameterStyle.FORM,
    schema=DotNumberSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _list_all_mapped_args(
        ...
        dot_number: typing.Optional[str] = None,
        ...
        if dot_number is not None:
            _query_params["dotNumber"] = dot_number
        if tag is not None:
