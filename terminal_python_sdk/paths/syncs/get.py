...
class BaseApi(api_client.Api):
    ...
    def _list_sync_history_mapped_args(
        self,
    ...
    async def _alist_sync_history_oapg(
        self,
...
class ListSyncHistoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_sync_history(
        self,
        limit: typing.Optional[str] = None,
        cursor: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_sync_history_mapped_args(
            limit=limit,
            cursor=cursor,
            status=status,
            expand=expand,
        ...
        return await self._alist_sync_history_oapg(
    ...
    def list_sync_history(
        ...
        return self._list_sync_history_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class ListSyncHistory(BaseApi):
    ...
    async def alist_sync_history(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_sync_history(
            limit=limit,
            cursor=cursor,
            status=status,
            expand=expand,
    ...
    def list_sync_history(
        ...
        raw_response = self.raw.list_sync_history(
            limit=limit,
            cursor=cursor,
            status=status,
            expand=expand,
