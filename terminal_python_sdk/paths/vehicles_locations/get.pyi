...
class BaseApi(api_client.Api):
    ...
    def _get_latest_locations_mapped_args(
        self,
    ...
    async def _aget_latest_locations_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/vehicles/locations',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_latest_locations_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetLatestLocationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_latest_locations(
        self,
        cursor: typing.Optional[str] = None,
        limit: typing.Optional[str] = None,
        raw: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_latest_locations_mapped_args(
            cursor=cursor,
            limit=limit,
            raw=raw,
        ...
        return await self._aget_latest_locations_oapg(
    ...
    def get_latest_locations(
        ...
        return self._get_latest_locations_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetLatestLocations(BaseApi):
    ...
    async def aget_latest_locations(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_latest_locations(
            cursor=cursor,
            limit=limit,
            raw=raw,
            vehicle_ids=vehicle_ids,
    ...
    def get_latest_locations(
        ...
        raw_response = self.raw.get_latest_locations(
            cursor=cursor,
            limit=limit,
            raw=raw,
            vehicle_ids=vehicle_ids,
