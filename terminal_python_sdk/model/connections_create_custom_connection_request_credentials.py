...
class ConnectionsCreateCustomConnectionRequestCredentials(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["database", "password", "username", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["database", "password", "username", ], str]):
