...
class ConnectionsCreateCustomConnectionRequestBackfill(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["startFrom"]) -> MetaOapg.properties.startFrom: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["days", "startFrom", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["startFrom"]) -> typing.Union[MetaOapg.properties.startFrom, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["days", "startFrom", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        startFrom: typing.Union[MetaOapg.properties.startFrom, str, schemas.Unset] = schemas.unset,
